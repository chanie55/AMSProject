...
<html>
    <head>
        <link rel = "stylesheet" href = "css\tenantProfile.css"/>
    ...
    <section class="body">    
        <nav>
            <ul>
                ...
                <li><a href="adminDashboard.html" class="menu">
                ...
                <li><a href="paymentHistory.html" class="menu">
                    <img src="" alt=""> <i class="ams history"></i>
                    <span class="nav-item">Payment History</span>
                </a> </li>
                <li><a href="index.html" class="menu logout">
